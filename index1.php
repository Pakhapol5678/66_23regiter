...
<head>
    ...
    <style>
        ...
        h1 {
            color: #d32f2f; /* Dark red for the heading */
            font-weight: bold;
        }
        p {
            font-size: 1.25rem;
            margin-top: 1rem;
            margin-bottom: 2rem;
            color: #c2185b; /* A shade of pink for the user info */
        }
        .logout-link {
            font-size: 1.1rem;
            color: #b71c1c; /* Darker red for the link */
...
<body>
    <div class="d-flex justify-content-center align-items-center main-container">
        <div class="content-card">
            <h1><i class="fas fa-home me-2"></i>ยินดีต้อนรับสู่หน้าหลัก</h1>
            <p>ผู้ใช้: **<?= htmlspecialchars($_SESSION['username']) ?>** (<?= htmlspecialchars($_SESSION['role']) ?>)</p>
            <a href="logout.php" class="logout-link">ออกจากระบบ <i class="fas fa-sign-out-alt ms-2"></i></a>
        </div>
    </div>
